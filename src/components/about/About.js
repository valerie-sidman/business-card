      ...
      <div className="about">
        ...
        <div className="about-container">
          <div className="about-content">
            ...
            <p className="about-text about-text__subsequent-paragraph">Во время учебы в институте я работала в офисе и была хорошо знакома с делопроизводством. Поэтому, после неудачной стажировки я приняла решение вернуться в эту область. Большая часть работы заключалась в ведении документаоборота и общениис клиентами. Но чувство, что я не на своём месте и способна на большее подтолкнуло меня на кардинальную смену профессии.</p>
          ...
          <div id="skills-anchor" className="resume-button-container">
